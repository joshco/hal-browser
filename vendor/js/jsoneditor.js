...
JSONEditor.defaults.editors.select = JSONEditor.AbstractEditor.extend({
  ...
  setupSelect2: function() {
    ...
    if(false && window.jQuery && window.jQuery.fn && window.jQuery.fn.select2 && (this.enum_options.length > 2 || (this.enum_options.length && this.enumSource))) {
...
JSONEditor.defaults.editors.multiselect = JSONEditor.AbstractEditor.extend({
  ...
  setupSelect2: function() {
      // kill select2
    if(false && window.jQuery && window.jQuery.fn && window.jQuery.fn.select2) {
